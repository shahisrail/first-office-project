(() => {
    ...
    n.n = t => {
        ...
        var t;
        n(777);
        jQuery.noConflict(), (t = jQuery)((function() {
            t("[data-fancybox]").fancybox();
            var e = t(".js-carousel");
            t(".js-carousel").length > 0 && (e.each((function() {
                t(this).slick()
            })), t(".js-carousel__buttons a").on("click", (function(e) {
                e.preventDefault(), e.stopPropagation(), t(this).closest(".js-carousel__holder").find(".js-carousel").slick(t(this).data("direction"))
            })))
        }))
    })()
})();